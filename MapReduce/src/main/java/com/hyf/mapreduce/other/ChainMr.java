package com.hyf.mapreduce.other;
...
public class ChainMr
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		ChainMapper.addMapper(conf, Mapper1.class, LongWritable.class, Text.class, Text.class, Text.class, false, map1);
		// Map2的过滤
		JobConf map2 = new JobConf(false);
		ChainMapper.addMapper(conf, Mapper2.class, Text.class, Text.class, Text.class, Text.class, false, map2);
		// 设置Reduce
		JobConf recduceFinallyConf = new JobConf(false);
		ChainReducer.setReducer(conf, Reducer3.class, Text.class, Text.class, Text.class, Text.class, false, recduceFinallyConf);
		// Reduce过后的Mapper过滤
		JobConf reduce1 = new JobConf(false);
		ChainReducer.addMapper(conf, Mapper4.class, Text.class, Text.class, Text.class, Text.class, true, reduce1);
