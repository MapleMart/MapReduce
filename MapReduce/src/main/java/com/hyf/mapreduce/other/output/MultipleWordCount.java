...
{
	public static class MultipleWordCountMapper extends Mapper<Object, Text, Text, IntWritable>
	{
	...
	public static class MultipleWordCountReducer extends Reducer<Text, IntWritable, Text, IntWritable>
	{
