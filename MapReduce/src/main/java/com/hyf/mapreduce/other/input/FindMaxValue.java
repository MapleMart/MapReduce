package com.hyf.mapreduce.other.input;
...
public class FindMaxValue
{
	...
	public static class FindMaxValueMapper extends Mapper<IntWritable, ArrayWritable, IntWritable, FloatWritable>
	{
	...
	public static class FindMaxValueReducer extends Reducer<IntWritable, FloatWritable, Text, FloatWritable>
	{
		public void reduce(IntWritable key, Iterable<FloatWritable> values, Context context) throws IOException, InterruptedException
		{
			...
			if (it.hasNext()) maxfloat = ((FloatWritable) (it.next())).get();
			else
			{
