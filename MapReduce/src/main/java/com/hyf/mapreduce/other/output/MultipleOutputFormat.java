package com.hyf.mapreduce.other.output;
...
public class MultipleOutputFormat<K extends WritableComparable<?>, V extends Writable> extends TextOutputFormat<K, V>
{
	...
	public class MultiRecordWriter extends RecordWriter<K, V>
	{
		...
		private String generateFileNameForKeyValue(K key, V value, Configuration conf)
		{
